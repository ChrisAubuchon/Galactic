...
loc_2EA:				; CODE XREF: ROM:02D5j	ROM:02DDj
		ld	hl, byte_4A51
		ld	a, (stru_4A57.itemCode)
		cp	(hl)
		jp	nz, loc_306
		ld	a, (stru_4A57.roomNum)
		inc	hl
		cp	(hl)
		jp	nz, loc_306
		ld	d, 0C0h	; '¿'
...
loc_625:				; CODE XREF: ROM:061Bj
		ld	a, (crystalStatueData.field_5)
		cp	22h ; '"'
		jp	z, loc_DB1
		ld	a, (byte_4960)
		add	a, 5
...
loc_1A00:				; CODE XREF: ROM:1973j
		...
		ld	e, 8
		call	printFromMSGFile
		ld	a, (psuitData.itemCode)
		cp	3
		jp	nz, loc_1A40
		ld	a, (psuitData.roomNum)
		cp	6
		jp	nz, loc_1A40
		ld	a, 8
		ld	(psuitData.itemCode), a
...
loc_3E08:				; CODE XREF: ROM:3DFDj
		ld	hl, crystalStatueData.field_5
		ld	(hl), 1Bh
...
byte_4297:	db 59h			; DATA XREF: ROM:424Cr	ROM:4254w ...
		db  52h	; R
		db  42h	; B
byte_429A:	db 47h			; DATA XREF: ROM:424Fw	ROM:426Dr ...
		db  2Dh	; -
		db  1Bh
		db  59h	; Y
		db  33h	; 3
...
byte_47E0:	db 1Bh			; DATA XREF: ROM:3D34o
		...
		db  20h
		db  80h	; Ä
unk_47E6:	db  1Bh			; DATA XREF: ROM:3C7Fo
		db  59h	; Y
...
solomawLandData:orbitStruMaybe <0, 0CFh, 8> ; DATA XREF: ROM:058Bw ROM:05C7w ...
		...
		db    1
		db    1
stru_49DF:	earthBasedItems	<1, re_sheriffs_office,	0, 0, 2, 2>
					; DATA XREF: ROM:inPiratesRoomo
					; ROM:0AEFo ...
stru_49E5:	earthBasedItems	<1, re_your_room, 2, 0,	3, 3> ;	DATA XREF: ROM:164Er
stru_49EB:	earthBasedItems	<ic_cantGet, re_your_room, 2, 0, 4, 4>
					; DATA XREF: ROM:167Fo	ROM:loc_3840o
stru_49F1:	earthBasedItems	<ic_cantGet, re_your_room, 3, 1, 5, 0>
					; DATA XREF: ROM:loc_616r ROM:1685o
stru_49F7:	earthBasedItems	<ic_cantGet, r_parson, 3, 1, 7,	0> ; DATA XREF:	ROM:04A5o
					; ROM:inSupply_1r ...
neuralItem:	earthBasedItems	<ic_cantGet, r_parson, 3, 0, 9,	5> ; DATA XREF:	ROM:04F0r
					; ROM:371Do
stru_4A03:	earthBasedItems	<ic_cantGet, r_parson, 3, 0, 0Bh, 6>
					; DATA XREF: ROM:loc_502r ROM:0E14r ...
psuitData:	earthBasedItems	<ic_cantGet, r_parson, 5, 0, 0Fh, 8> ; DATA XREF: ROM:19F5w
					; ROM:1A2Br ...
stru_4A0F:	earthBasedItems	<1, re_sheriffs_office,	0Ch, 0,	11h, 0Ah>
					; DATA XREF: ROM:loc_176Fo ROM:1BECo
stru_4A15:	earthBasedItems	<1, re_bomb_shelter, 4,	0, 13h,	0Bh> ; DATA XREF: ROM:4564r
purseData:	isthurBasedItems <ic_cantGet, ri_bubble_39, 5, 0, 14h, 0Ch>
					; DATA XREF: ROM:16A1r
					; ROM:searchBubble39o
		isthurBasedItems <2, 20h, 0Dh, 0, 15h, 0Dh>
stru_4A27:	isthurBasedItems <ic_cantGet, r_computer_center, 0, 0, 16h, 0Eh>
					; DATA XREF: ROM:04D2r	ROM:1297w
byte_4A2D:	db 4			; DATA XREF: ROM:loc_1189r ROM:11C9r
		db  1Eh
		db    0
		db    1
		db  17h
		...
		db    0
		db    1
byte_4A3D:	db 19h			; DATA XREF: ROM:loc_2D8r ROM:1177r ...
		db    0
		db    4
		db  2Ch	; ,
		db    0
		...
		db  1Bh
		db    0
byte_4A45:	db 4			; DATA XREF: ROM:3F07r	ROM:3F48r ...
		db  2Dh	; -
		db    0
		db    0
		db  20h
		db  0Fh
byte_4A4B:	db 8			; DATA XREF: ROM:02ABr	sub_1CADo ...
byte_4A4C:	db 0			; DATA XREF: ROM:02B3r
		db    0
		db    0
		db  21h	; !
		db  11h
byte_4A51:	db 4			; DATA XREF: ROM:loc_290o ROM:loc_2A8o ...
byte_4A52:	db '2'                  ; DATA XREF: ROM:loc_2CBr ROM:40BBr
byte_4A53:	db 2			; DATA XREF: ROM:0590w
		db    0
		db  22h	; "
		db  13h
stru_4A57:	gcsBasedItems <ic_cantGet, 32h,	0, 1, 23h, 0> ;	DATA XREF: ROM:02EDr
					; ROM:084Ar ...
byte_4A5D:	db 4			; DATA XREF: ROM:0CF8w
		db  31h	; 1
		db    0
		db    0
		db  25h	; %
		db  14h
byte_4A63:	db 4			; DATA XREF: ROM:loc_3F19r ROM:3F2Aw
		db  37h	; 7
		db    0
		db    0
		db  26h	; &
		db  15h
byte_4A69:	db 4			; DATA XREF: ROM:3F50r	ROM:3F61w
		db  3Eh	; >
byte_4A6B:	db 2			; DATA XREF: ROM:059Aw
		db    0
		db  22h	; "
		db  16h
byte_4A6F:	db 8			; DATA XREF: ROM:0852r	ROM:089Fr ...
byte_4A70:	db ':'                  ; DATA XREF: ROM:059Fw
		db    7
		db    0
		db  28h	; (
		db  17h
stru_4A75:	gcsBasedItems <ic_cantGet, 5, 0, 0, 29h, 18h> ;	DATA XREF: ROM:193Fr
					; ROM:1BBFw ...
		db    5
		db  0Ah
		db    0
		...
		db  2Bh	; +
		db  1Ah
crystalStatueData:earthBasedItems <5, 33h, 0, 0, 2Ch, 1Bh> ; DATA XREF:	ROM:loc_3968o
					; ROM:loc_625r	...
radSuitData:	isthurBasedItems <2, 12h, 0, 0,	2Dh, 1Ch> ; DATA XREF: ROM:loc_3DA2o
keyData:	gcsBasedItems <ic_cantGet, rg_storage_space, 5,	0, 2Fh,	1Dh>
					; DATA XREF: ROM:loc_1376r
					; ROM:loc_1827r ...
...
byte_4AAB:	db 8			; DATA XREF: ROM:0ABFw	ROM:0B1Aw ...
		db  0Fh
earthRoomData:	db 0			; [0].scoreBonus ; DATA	XREF: getBGNRoomAddress+1Ao
		db 40h			; [0].roomFlags
