g_gcsRoomData:		ROOM(``room_gcs_inOrbit'', 0, 
			...
			ROOM(``room_gcs_airlessPassage'', 0, 
			...
			ROOM(``room_gcs_computerCenter'', 25, 
				BITMASK(roomFlag_verbose, roomFlag_clock, roomFlag_terminal),
				s_terse_gcsComputerCenter, s_terse_gcsComputerCenter,
				s_none, s_none,
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply,
			...
			ROOM(``room_gcs_innerCorridor_18'', 0,
				BITMASK(roomFlag_verbose),
				s_verbose_innerCorridor, s_terse_innerCorridor,
				s_none, s_none,
				room_cantApply, room_cantApply,
			...
			ROOM(``room_gcs_innerCorridor_1A'', 0,
				BITMASK(roomFlag_verbose),
				s_verbose_innerCorridor, s_terse_innerCorridor,
				s_none, s_none,
				room_cantApply, room_cantApply,
			...
			ROOM(``room_gcs_innerCorridor_1B'', 0,
				BITMASK(roomFlag_verbose),
				s_verbose_innerCorridor, s_terse_innerCorridor,
				s_none, s_none,
				room_cantApply, room_cantApply,
			...
			ROOM(``room_gcs_outerCorridor_1E'', 0, 
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply,
				room_gcs_innerCorridor_16, room_gcs_outerCorridor_1D,
			...
			ROOM(``room_gcs_outerCorridor_20'', 0, 
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply,
				room_gcs_outerCorridor_21, room_gcs_innerCorridor_16,
				room_gcs_gymnasium, room_cantGo,
				room_gcs_gymnasium, room_cantGo)
			ROOM(``room_gcs_outerCorridor_21'', 0,
				BITMASK(roomFlag_verbose),
				s_verbose_outerCorridor, s_terse_outerCorridor,
				s_none, s_none,
				room_cantApply, room_cantApply,
			...
			ROOM(``room_gcs_innerCorridor_24'', 0,
				BITMASK(roomFlag_verbose),
				s_verbose_innerCorridor, s_terse_innerCorridor,
				s_none, s_none,
				room_cantApply, room_cantApply,
