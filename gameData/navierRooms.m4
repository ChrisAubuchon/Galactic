g_navierRoomData:	ROOM(``room_navier_inOrbit'', 0, 
			...
			ROOM(``room_navier_smallRoom_A'', 0, 
				BITMASK(roomFlag_verbose),
				s_verbose_navier_smallRoom, s_verbose_navier_smallRoom,
				s_none, s_none,
			...
			ROOM(``room_navier_undergroundMain'', 0, 
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_slopingTunnel'', 30, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
			...
			ROOM(``room_navier_diningRoom'', 0, 
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_servantFoyer'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				...
				room_cantApply, room_cantApply)
			ROOM(``room_navier_servantQuarters'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
			...
			ROOM(``room_navier_kitchen'', 0, 
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_narrowTunnel'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_gentleSlope_1B'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_gentleSlope_1C'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				s_verbose_navier_gentleSlope, s_verbose_navier_gentleSlope,
				s_none, s_none,
				room_cantGo, room_cantGo,
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_barracksEntrance'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_smallBedroom_1E'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				...
				room_cantApply, room_cantApply)
			ROOM(``room_navier_smallBedroom_1F'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				s_verbose_navier_smallBedroom, s_terse_navier_smallBedroom,
				s_none, s_none,
				room_cantGo, room_cantGo,
				...
				room_cantApply, room_navier_barracksEntrance,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_smallBedroom_20'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				s_verbose_navier_smallBedroom, s_terse_navier_smallBedroom,
				s_none, s_none,
				room_cantGo, room_cantGo,
				...
				room_cantApply, room_navier_barracksEntrance,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_levelOneEntrance'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_first, roomFlag_illusion),
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_nsewIntersection'', 24, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_ewTunnel_23'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
			...
			ROOM(``room_navier_lavaBed'', 0, 
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_curvingCanyon'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_besideLakeBed'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
			...
			ROOM(``room_navier_boxCanyon'', 5, 
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_levelTwoEntrance'', 5, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_lockableDoors'', 27, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
			...
			ROOM(``room_navier_lakeEdge'', 0, 
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_inRowboatOnLake'', 5, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				...
				room_cantApply, room_cantApply)
			ROOM(``room_navier_inRowboatNearShelf'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
			...
			ROOM(``room_navier_airlock'', 14, 
				...
				room_doorLocked, room_doorLocked,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_computerCenter'', 17, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				...
				room_cantApply, room_cantApply)
			ROOM(``room_navier_longCorridor_33'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_longCorridor_34'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				s_verbose_navier_longCorridor, s_verbose_navier_longCorridor,
				s_none, s_none,
				room_cantGo, room_cantGo,
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_longCorridor_35'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_emptyStoreroom'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				...
				room_cantApply, room_cantApply)
			ROOM(``room_navier_oldStoreroom'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				...
				room_cantApply, room_navier_longCorridor_35,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_stairBottom'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				...
				room_cantApply, room_cantApply,
				room_cantApply, room_cantApply)
			ROOM(``room_navier_puzzleTesting'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
				...
				room_cantApply, room_cantApply)
			ROOM(``room_navier_tomorrowChamber'', 0, 
				BITMASK(roomFlag_verbose, roomFlag_illusion),
